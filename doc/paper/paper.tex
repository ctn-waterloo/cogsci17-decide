...
The winner-take-all (WTA) mechanism is a network that selects the largest value among a number of possible inputs.
...
This mechanism is regularly employed as a component of cognitive models involving decision making, in which the most useful action is selected to drive behaviour~\cite<e.g.,>{oreilly1998}. 
