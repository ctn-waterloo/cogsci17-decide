...
The dynamics for each state variable $x_i(t),\ 1 \leq i \leq D$, where $D$ is the number of choices, are given by~(see Fig.~\ref{fig:usher-mcclelland}):
...
\begin{figure}
    ...
    \caption{\todo{caption}}\label{fig:ia-sketch}
\end{figure}
