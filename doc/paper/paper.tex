...
The first mechanism we consider is an implementation of the {\it leaky, competing accumulator} (LCA) model from~\citeA{usher2001}.
...
The second mechanism we consider is the {\it independent accumulator} (IA) model that we propose here, and which involves a secondary thresholding layer that is recurrently connected to a primary integrating layer.
